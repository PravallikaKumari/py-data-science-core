...
#tips = pd.read_csv(r"py-data-science-core/04_Data_Analysis_projects/streamlit(Seaborn)/tips_dataset.csv")
tips=sns.load_dataset("tips")
data_path = Path(__file__).resolve().parent / "tips_dataset.csv"
tips = pd.read_csv(data_path)


# Streamlit app
st.title("Comprehensive Tips Dataset Visualizations by pravallika kumari")
st.write("This app displays a variety of Seaborn plots created by pravallika kumari exploring the Tips dataset, which includes data on restaurant bills and tips.")
